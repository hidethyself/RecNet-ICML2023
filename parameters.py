...
def get_params(argv='4'):
    ...
    params = dict(
        ...
        dataset_dir='./DCASE2021_SELD_dataset',
        ...
        scaler_type=1,  # 1 for MinMaxScaler(); 0 for StandardScaler()
        experiment=None,  # None: to run with 4 channels or [no_channel(int), fill_type (0: zero, 1: Gaussian noise)]
        pct=.75,
        no_channel_to_dop=1,
        dci_lr=1e-3,
        corelated_channel={0: 1, 1: 0, 2: 3, 3: 2},
        seed=512,
        type_=2,
    )
